          ...
          <div className="max-w-screen-xl mx-auto px-4">
            <div className="grid md:grid-cols-3 gap-8">
              ...
              <div>
                ...
                <ul className="space-y-2">
                  <li><Link href="/get-mentorship" className="text-gray-300 hover:text-white flex items-center gap-2">
                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                      <path d="M20 4H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 4l-8 5-8-5V6l8 5 8-5v2z"/>
                    </svg>
                    Get Mentorship
                  </Link></li>
                  <li><Link href="https://github.com/moshakib" className="text-gray-300 hover:text-white flex items-center gap-2" target="_blank" rel="noopener noreferrer">
                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  <li><Link href="https://youtube.com/@pathtodev" className="text-gray-300 hover:text-white flex items-center gap-2" target="_blank" rel="noopener noreferrer">
                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
