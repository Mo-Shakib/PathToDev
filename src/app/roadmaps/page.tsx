  ...
  return (
    <div className="max-w-screen-xl mx-auto py-6 sm:py-8 px-4 sm:px-6">
      ...
      <section className="mb-12">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <div className="bg-white p-6 rounded-lg shadow-md">
            ...
            <p className="text-gray-600 mb-4">Build a strong foundation in web development fundamentals.</p>
          ...
          <div className="bg-white p-6 rounded-lg shadow-md">
            ...
            <p className="text-gray-600 mb-4">Master modern JavaScript and popular frameworks.</p>
            <ul className="list-disc list-inside text-gray-600">
      ...
      <section className="mb-12">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <div className="bg-white p-6 rounded-lg shadow-md">
            ...
            <p className="text-gray-600 mb-4">Learn to build robust and scalable backend services.</p>
            <ul className="list-disc list-inside text-gray-600">
          ...
          <div className="bg-white p-6 rounded-lg shadow-md">
            ...
            <p className="text-gray-600 mb-4">Master the tools and practices for modern deployment.</p>
            <ul className="list-disc list-inside text-gray-600">
      ...
      <section className="bg-gray-50 p-8 rounded-lg mb-12">
        ...
        <p className="text-center text-gray-600 mb-6">Dive deep into specific areas of software development</p>
        <div className="grid md:grid-cols-3 gap-6">
          <div className="bg-white p-4 rounded-lg">
            <h3 className="font-semibold mb-2 text-gray-900">Mobile Development</h3>
            <p className="text-sm text-gray-600">React Native and cross-platform development</p>
          </div>
          <div className="bg-white p-4 rounded-lg">
            <h3 className="font-semibold mb-2 text-gray-900">Cloud Architecture</h3>
            <p className="text-sm text-gray-600">Building scalable cloud solutions</p>
          </div>
          <div className="bg-white p-4 rounded-lg">
            <h3 className="font-semibold mb-2 text-gray-900">AI & Machine Learning</h3>
            <p className="text-sm text-gray-600">Integration of AI in web applications</p>
          </div>
        </div>
      </section>
    </div>
